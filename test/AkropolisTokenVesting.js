require('chai')
    ...
    contract('AkropolisTokenVesting', function ([_, wallet1, wallet2, wallet3, wallet4, wallet5]) {
        it('should be initialized correctly', async function () {
            let token = "0xC4375B7De8af5a38a93548eb8453a498222C4fF2";
            let start = 1569937264;
            let cliffDuration = 1569937264;
            let duration = 1569937264;
